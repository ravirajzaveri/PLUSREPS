export default function TermsPage() {
  return (
    <main className="prose mx-auto px-4 py-8">
      ...
      <p>
        If you purchase a subscription, donate, or tip a streamer:
      </p>
      <ul>
        <li>Payments are processed via Razorpay.</li>
        <li>You agree to the pricing, billing frequency, and refund terms disclosed at the point of purchase.</li>
        <li>Revenue sharing with creators is managed as per our Streamer Agreement.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Post or stream misleading, harmful, or offensive content.</li>
      ...
      <p>
        These Terms shall be governed by and construed in accordance with the laws of India. Any disputes will be subject to the exclusive jurisdiction of the courts in New Delhi.
      </p>
