// pages/legal/ad-choices.tsx

export default function AdChoicesPage() {
  return (
    <main className="prose mx-auto px-4 py-8">
      <h1>Ad Choices Policy</h1>
      ...
      <p>
        We and our partners may use cookies, device identifiers, and other tracking technologies to deliver ads that are more relevant to your interests.
      </p>
      <p>Examples include:</p>
      <ul>
        <li>Suggested fitness products based on workout streams you view</li>
        <li>Local health offers based on your general location</li>
        <li>Creators you may like based on your interaction history</li>
      </ul>
      ...
      <p>We do not share personally identifiable information with advertisers.</p>
      ...
      <ul>
        ...
        <li>Your device and browser ad settings</li>
      </ul>
      <p><strong>Note:</strong> You may still see ads, but they may be less relevant.</p>

      <h2>5. Children and Ads</h2>
      <p>
        We do not deliver targeted advertising to users under the age of 13 or where prohibited by law.
      </p>

      <h2>6. Updates to This Policy</h2>
      <p>
        We may update this policy from time to time. Significant changes will be communicated via our platform.
      </p>
